import { test, expect } from '@playwright/test'; //Import tests

// POSITIVE test — checks that something IS as expected
test('page has the correct title', async ({ page }) => { //our test
...
test('page does not contain error text', async ({ page }) => { //our sec
  await page.goto('https://playwright.dev/');
